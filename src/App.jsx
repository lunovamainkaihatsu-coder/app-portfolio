...
const APPS = [
  ...
  },
  {
    ...
    description: "  今日は休んだ？",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-3nx3qbqhymksuhuvxxuf6h.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "  あと何回？",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitigohan-bf7p4jct84kdaadxvonqej.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "  今日の1個",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-kzcvxhl56sg88fkytatfro.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    name: " 今日ひとつ片付けた",
    tagline: " 今日ひとつ片付けた",
    description: "  今日ひとつ片付けた",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-pukdoydzivhqryttuoxlak.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    name: "  今日よかったこと1つ",
    tagline: "  今日よかったこと1つ",
    description: "   今日よかったこと1つ",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-xzbzpwvqzyixbbpgcs3mki.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "   やる？やらない？",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-rnoesom8dhkmlew6gfhprk.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "今どれくらい？",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-uqkuztcjfneythbvgvdpzd.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "今日なに覚えた？",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-jz9up5cd3t9xf4lcuz8ed6.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: " 1日1アイデア",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-5ydqfqbrkq8luxi28gk4vq.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    name: " 最後にやったのいつ？",
    tagline: "  最後にやったのいつ？",
    description: " 最後にやったのいつ？",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-cnidjyxr7pxy9xox3mnp58.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    name: "今から10分なにする",
    tagline: "今から10分なにする",
    description: "今から10分なにする",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-mz5m5sgspm7xdwxaeyab4c.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "今日の優先3つ",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "http://mainitiapp-zqivbkjqw6z36o9ywdzdge.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    name: "今日の小さな勝ち",
    tagline: "今日の小さな勝ち",
    description: "今日の小さな勝ち",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-ynwlfbvfqyabsyoxo8xdng.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "これ、いつまで",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-ymdbbadrmfpplxl3frb5hp.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    name: "今どこまでやった？",
    tagline: "今どこまでやった？",
    description: "今どこまでやった？",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-7yhyscuzbh8gmboekwm49v.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "今の集中度",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-dcwkoccvazupj7ubckupcu.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    name: "未来の自分に1問",
    tagline: "未来の自分に1問",
    description: "未来の自分に1問",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitigohan-lejpoepehnezqcmetfxsrf.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "今日のごほうび",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-dqbndprjmmuv8zrxmdakjw.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "今日やめたこと",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-aufhm6fwwv7x5zlufixtsg.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    description: "今日のベスト1",
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-gdfwrvpn8wmsazh5dhkuqj.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
    ...
    // ↓ここを、ご主人のアプリのURLに差し替えてね
    url: "https://mainitiapp-crermxfkrpyxprdwxncngy.streamlit.app/",
    repo: "",
    tags: ["Web"],
    status: "公開中",
    // 今日の日付などに更新
...
const POSTS = [
  ...
  },
 {
  ...
  },
  {
    ...
    date: "2026-8-25", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/n1334af901f13?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-238",
    ...
    date: "2026-8-26", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/ndd541229a570",
    tags: ["DevLog"],
  },
      {
    id: "note-239",
    title: "今日ひとつ片付けたを公開しました",
    // 公開した日
    date: "2026-8-27", 
    // ↓ここを記事のURLに変える
    ...
    tags: ["DevLog"],
      ...
      {
    id: "note-241",
    title: "今日よかったこと1つを公開しました",
    // 公開した日
    date: "2026-8-29", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/nae66dbd8b3bf?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-242",
    title: "やる？やらない？を公開しました",
    // 公開した日
    date: "2026-8-30", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/ncde74d2756de?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-243",
    ...
    date: "2026-8-31", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/n284a1be08c3e?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-244",
    title: "今日なに覚えた？を公開しました",
    // 公開した日
    date: "2026-9-1", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/nb1802339423f?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-245",
    title: "1日1アイデアを公開しました",
    // 公開した日
    date: "2026-9-2", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/n43f4f1072543?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-246",
    title: "最後にやったのいつ？を公開しました",
    // 公開した日
    date: "2026-9-3", 
    // ↓ここを記事のURLに変える
    ...
    tags: ["DevLog"],
      ...
      {
    id: "note-251",
    title: "今日の優先3つを公開しました",
    // 公開した日
    date: "2026-9-8", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/n02811cea2c6a?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-252",
    title: "今日の小さな勝ちを公開しました",
    // 公開した日
    date: "2026-9-9", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/n85d087da2456?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-253",
    title: "これ、いつまで？を公開しました",
    // 公開した日
    date: "2026-9-10", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/n70c425311545?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-254",
    title: "今どこまでやった？を公開しました",
    // 公開した日
    date: "2026-9-11", 
    // ↓ここを記事のURLに変える
    ...
    tags: ["DevLog"],
      ...
      {
    id: "note-261",
    title: "今日のごほうびを公開しました",
    // 公開した日
    date: "2026-9-18", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/nde4cb35c74ba?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-262",
    ...
    tags: ["DevLog"],
      ...
      {
    id: "note-264",
    title: "今日やめたことを公開しました",
    // 公開した日
    date: "2026-9-21", 
    // ↓ここを記事のURLに変える
    url: "https://note.com/lunova_create/n/n211eb4936f63?app_launch=false",
    tags: ["DevLog"],
  },
      {
    id: "note-265",
    title: "今日のベスト1を公開しました",
    // 公開した日
    date: "2026-9-22", 
    // ↓ここを記事のURLに変える
